...
class groceryTodoHomePage extends StatefulWidget {
  const groceryTodoHomePage({Key? key}) : super(key: key);

  @override
  State<groceryTodoHomePage> createState() => _groceryTodoHomePageState();
}

class _groceryTodoHomePageState extends State<groceryTodoHomePage> {
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (selectedItem == "Today" && category == "grocery") {
