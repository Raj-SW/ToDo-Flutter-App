...
class AddTodoHomePage extends StatefulWidget {
  const AddTodoHomePage({Key? key}) : super(key: key);

  @override
  State<AddTodoHomePage> createState() => _AddTodoHomePageState();
}

class _AddTodoHomePageState extends State<AddTodoHomePage> {
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (selectedItem == "Today" && category == "todos") {
